...
input_feats="0 1 2 3 4 5 6 7" # th, mot
...
do
    echo "Running with index $i..."
    python3 "$script_dir"/ssgp_fitting.py --train 1 --nbf $n_basis_functions --x $state_feats --u $input_feats --y $i --ds_name "20230910_185814-TRAIN-BEM"
